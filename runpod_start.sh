...
pip install hf_transfer datasets huggingface_hub pyarrow tqdm arctic-inference==0.1.1 setuptools-scm fastapi uvicorn outline-sdk
pip install vllm xformers --no-deps
