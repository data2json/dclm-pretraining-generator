...
pip install hf_transfer datasets huggingface_hub pyarrow tqdm arctic-inference==0.1.1 https://github.com/Dao-AILab/flash-attention/releases/download/v2.8.3/flash_attn-2.8.3+cu12torch2.8cxx11abiTRUE-cp312-cp312-linux_x86_64.whl vllm
