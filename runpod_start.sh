...
pip install vllm datasets huggingface_hub pyarrow tqdm arctic-inference[vllm] https://github.com/Dao-AILab/flash-attention/releases/download/v2.8.3/flash_attn-2.8.3+cu12torch2.8cxx11abiFALSE-cp312-cp312-linux_x86_64.whl
